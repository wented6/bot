...
let nekoclient = new Neko.Client(); // default api key is defaulted :D
	...
	if (uwu == "lewd"){
	const nsf = message.guild.channels.find("name", "nsfw");
	if (message.channel.name !== "nsfw" && !message.channel.nsfw)return message.channel.send("Don't do that here BAKA .. there are kids around");
